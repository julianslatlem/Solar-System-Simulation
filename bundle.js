...
const earthAtmosphereMat1 = new ShaderMaterial({
...
earthAtmosphere1.scale.set(1.004, 1.004, 1.004);
earth.add(earthAtmosphere1);

const earthAtmosphereMat2 = new ShaderMaterial({
...
earthAtmosphere2.scale.set(0.97, 0.97, 0.97);
