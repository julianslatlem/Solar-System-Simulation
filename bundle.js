...
new Vector3(0, 0, -guiVariables.earthDistance * km);
...
function animate() {
    ...
    guiVariables.moonDistance / guiVariables.planetDistanceDivider * km;
    ...
    const marsOrbitSpeed = (guiVariables.marsOrbitSpeed * (km / sec)) / Math.sqrt(Math.pow(guiVariables.marsDistance / (10000 * Math.PI), 3)) - earthOrbitSpeed;    const jupiterOrbitSpeed = (guiVariables.jupiterOrbitSpeed * (km / sec)) / Math.sqrt(Math.pow(guiVariables.jupiterDistance / (100000 * Math.PI), 3)) - earthOrbitSpeed;    
    controls.update();
